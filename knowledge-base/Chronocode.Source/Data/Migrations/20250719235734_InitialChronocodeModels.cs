...
{
    /// <inheritdoc />
    public partial class InitialChronocodeModels : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ChargeCodes_Projects_ProjectId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProjectEngineers_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Activities_ProjectTasks_TaskId",
                        column: x => x.TaskId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AllocatedHours = table.Column<decimal>(type: "decimal(5,2)", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "TEXT", nullable: false),
                    ModifiedDate = table.Column<DateTime>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ActivityChargeCodes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ActivityChargeCodes_Activities_ActivityId",
                        column: x => x.ActivityId,
                        principalTable: "Activities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ActivityChargeCodes_ChargeCodes_ChargeCodeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ActivityChargeCodes_ActivityId",
                table: "ActivityChargeCodes",
                column: "ActivityId");

            migrationBuilder.CreateIndex(
                name: "IX_ActivityChargeCodes_ChargeCodeId",
                table: "ActivityChargeCodes",
                column: "ChargeCodeId");

            migrationBuilder.CreateIndex(
                name: "IX_ChargeCodes_Code_ProjectId",
                table: "ChargeCodes",
                columns: new[] { "Code", "ProjectId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ChargeCodes_ProjectId",
                table: "ChargeCodes",
                column: "ProjectId");
